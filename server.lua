...
RegisterServerEvent('valiant_trucking:startJob')
AddEventHandler('valiant_trucking:startJob', function(id)
    ...
    if hasJob then
        if not Config.Jobs[id]['taken'] then
            ...
            TriggerClientEvent('valiant_trucking:start', xPlayer.source, Config.Jobs[id], id)
        else
...
RegisterServerEvent('valiant_trucking:jobMenu')
AddEventHandler('valiant_trucking:jobMenu', function()
    ...
    TriggerClientEvent('valiant_trucking:menu', xPlayer.source, elements)
end)

RegisterServerEvent('valiant_trucking:jobFinished')
AddEventHandler('valiant_trucking:jobFinished', function(id, damages)
